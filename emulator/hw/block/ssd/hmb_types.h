...
typedef struct HmbFastIOCtrl
{
	bool enabled;
	HmbMappedAddr *meta; /* HmbSplitTable */

	HmbMappedAddr*  data_ST;
	HmbMappedAddr** data_mapped;
	uint32_t        data_ST_unit;
	uint16_t        data_ST_num;
	uint64_t        max_data_size_bytes;
} HmbFastIOCtrl;
...
extern HmbFastIOCtrl HMB_FASTIO_CTRL;
